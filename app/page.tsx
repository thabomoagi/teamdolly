      ...
      <section id="book" className="relative h-screen flex flex-col items-center justify-end pb-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 space-y-6">
          ...
          >
            ...
            <a href="https://www.tiktok.com/@teamdolly1" target="_blank" rel="noopener noreferrer" className="text-[#888] hover:text-white transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
